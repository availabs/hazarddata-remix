...
var RenderDeps = ({ dependencies = {}, viewId, srcMeta, viewMeta }) => {
  let depViews = (0, import_lodash34.default)(dependencies.dependencies.find((d) => d.view_id.toString() === viewId.toString()), "view_dependencies") || [];
...
async function loader8({ request }) {
  let ltsViews = ["dama", pgEnv, "sources", "byId", [271, 276, 273, 266], "views", "lts"];
  await falcor2.get(ltsViews);
  let falcorCache = falcor2.getCache(), ltsHlrView = (0, import_lodash40.default)(falcorCache, ["dama", pgEnv, "sources", "byId", 271, "views", "lts", "value"]), ltsEalView = (0, import_lodash40.default)(falcorCache, ["dama", pgEnv, "sources", "byId", 273, "views", "lts", "value"]), ltsEnhancedNCEIView = (0, import_lodash40.default)(falcorCache, ["dama", pgEnv, "sources", "byId", 276, "views", "lts", "value"]), sourceData = await falcor2.get(
    ["eal", pgEnv, "source", 273, "view", "lts", "data"],
    ["nri", pgEnv, "source", 266, "view", "lts", "totals"],
    ["ncei_storm_events_enhanced", pgEnv, "source", 276, "view", "lts", "lossByYearByType"],
  ...
  return {
    ...
    enhancedNCEILossLts: (0, import_lodash40.default)(sourceData, ["json", "ncei_storm_events_enhanced", pgEnv, "source", 276, "view", "lts", "lossByYearByType"], []),
    ealAvailLts: (0, import_lodash40.default)(sourceData, ["json", "eal", pgEnv, "source", 273, "view", "lts", "data"], []).filter((d) => !["Heavy Rain", "Freezing Fog"].includes(d.nri_category)),
    nriLts: (0, import_lodash40.default)(sourceData, ["json", "nri", pgEnv, "source", 266, "view", "lts", "totals", 0], []),
